 ...
 */
final class Version20250507145148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE player ADD player_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE player ADD CONSTRAINT FK_98197A6599E6F5DF FOREIGN KEY (player_id) REFERENCES player (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            CREATE UNIQUE INDEX UNIQ_98197A6599E6F5DF ON player (player_id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE player DROP FOREIGN KEY FK_98197A6599E6F5DF
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX UNIQ_98197A6599E6F5DF ON player
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE player DROP player_id
        SQL);
    }
}
